        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShippingSlipId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PurchaseOrders_ShippingSlips_ShippingSlipId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PurchaseOrderProduct", x => new { x.ProductsId, x.PurchaseOrderId });
                    table.ForeignKey(
                        name: "FK_PurchaseOrderProduct_Products_ProductsId",
                        column: x => x.ProductsId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PurchaseOrderProduct_PurchaseOrders_PurchaseOrderId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PurchaseOrders_ShippingSlipId",
                table: "PurchaseOrders",
